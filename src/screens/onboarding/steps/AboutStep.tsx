...
const LOOKING_FOR: { value: LookingFor; label: string; sub: string }[] = [
  { value: 'serious', label: 'Serious',  sub: 'Long-term, the real thing.' },
  { value: 'casual',  label: 'Casual',   sub: 'Dating, see where it goes.' },
  { value: 'friends', label: 'Friends',  sub: 'People to vibe with.' },
]
    ...
    <div className="space-y-6">
      <section className="space-y-2">
        ...
        <div className="glass rounded-2xl p-4 focus-within:ring-brand transition-shadow">
          <textarea
            ...
            rows={3}
            maxLength={300}
            placeholder="Something real — what makes you, you?"
      ...
      <section className="space-y-3">
        <div className="flex items-baseline justify-between px-1">
          ...
          >
            {data.hobbies.length}/{HOBBY_MAX} · pick {HOBBY_MIN}+
          </span>
        </div>

// Country list (full ISO 3166-1 alpha-2) + states for the markets where we
// have data. Used by the onboarding manual-location fallback. Countries
// without an entry in STATES fall back to a free-text region field.
...
export const COUNTRIES: Country[] = [
  ...
  { code: 'CD', name: 'Congo (DR)' }, { code: 'CK', name: 'Cook Islands' }, { code: 'CR', name: 'Costa Rica' },
  ...
  { code: 'VA', name: 'Holy See (Vatican City)' }, { code: 'HN', name: 'Honduras' }, { code: 'HK', name: 'Hong Kong' },
  ...
  { code: 'US', name: 'United States' }, { code: 'UM', name: 'U.S. Minor Outlying Islands' },
  { code: 'VI', name: 'U.S. Virgin Islands' }, { code: 'UY', name: 'Uruguay' }, { code: 'UZ', name: 'Uzbekistan' },
